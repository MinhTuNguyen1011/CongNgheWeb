...
<?php
	// Lấy 4 bài viết mới nhất đã được phép public ra ngoài từ bảng posts
	$sql = "select * from posts where is_public = 1 order by createdate desc limit 4";
				...
				<table width="100%" border="1">
					...
					?>
						<td >
							...
							<p><?php echo substr($data["content"], 0, 150)." ...";// In ra nội dung bài viết lấy chỉ 150 ký tự ?></p>
		...
		<nav>
			<div class="innertube">
				...
				<ul>
                    ...
                    <li><a href="them-bai-viet-ck.php">Thêm Bài Viết</a></li>
					<!--<li><a href="them-bai-viet-ck.php">Thêm Bài Giảng</a></li>-->
				...
				<ul>
					...
					<li><a href="quan-ly-thanh-vien.php">Sửa Thành Viên</a></li>
