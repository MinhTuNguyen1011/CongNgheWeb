	...
	<form action="chinh-sua-thanh-vien.php" method="post">
		<table style="margin-left:auto;margin-right:auto;">
			...
			<tr>
				...
				<td><input type="text" id="email" name="email"  style="margin-top:10px;margin-bottom:10px" value="<?php echo $data['email']; ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" name="btn_submit" value="Cập nhật thông tin" style="margin-top:15px;font-size:17px"></td>
			</tr>
