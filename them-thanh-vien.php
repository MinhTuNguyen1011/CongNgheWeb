...
?>
	...
	<form action="them-thanh-vien.php" method="post">
		<table style="margin-left:auto;margin-right:auto;">
			<tr>
				<td colspan="2" >
					<h3><center>Thêm thành viên</center></h3>
				</td>
			</tr>	
			<tr>
			...
			<tr >
				...
				<td><input type="password" name="password" id="password" value="" style="margin-top:10px" ></td>
			</tr>
			<tr>
				<td nowrap="nowrap">Họ tên :</td>
				<td><input type="text" name="fullname" id="fullname" value="" style="margin-top:10px" ></td>
			</tr>
			<tr>
				<td nowrap="nowrap">Địa chỉ email :</td>
				<td><input type="text" id="email" name="email" value="" style="margin-top:10px;margin-bottom:10px"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" name="btn_submit" value="Thêm thành viên" style="font-size:17px;margin-top:10px"></td>
			</tr>
